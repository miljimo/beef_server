...
class NodeSelectorControl(NodeControl):
     ...
     def __init__(self, graphNode =  None):
          ...
          self.BorderColor  =  wx.Colour("#00000081");
     ...
     def OnMouseEvent(self, event):
          Logger.Debug("Selector -> Mouse down event", level  = LoggerLevel.INFORMATION);
          if(isinstance(event, NodeMouseEvent)):
               print("Hell");
